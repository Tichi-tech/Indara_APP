...
import { ArrowLeft, Phone, Apple } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col h-full bg-white">
      ...
      <div className="flex-1 flex flex-col justify-center px-8">
        <h1 className="text-4xl font-light leading-tight mb-16 text-black">
          Sign in to your<br />
          Indara account
        </h1>
        ...
        <div className="flex justify-center gap-6">
          <button 
            ...
            className="w-12 h-12 bg-gray-100 rounded-xl flex items-center justify-center transition-all duration-200 hover:bg-gray-200 active:scale-95"
          >
          ...
          <button 
            ...
            className="w-12 h-12 bg-gray-100 rounded-xl flex items-center justify-center transition-all duration-200 hover:bg-gray-200 active:scale-95"
          >
            <svg className="w-6 h-6" fill="#7289DA" viewBox="0 0 24 24">
